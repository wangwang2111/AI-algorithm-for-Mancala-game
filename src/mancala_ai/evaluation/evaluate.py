...
from mancala_ai.engine.core import initialize_board, is_terminal, evaluate, get_valid_moves, make_move
from mancala_ai.agents.alpha_beta import minimax_alpha_beta
...
from mancala_ai.agents.mcts import mcts_decide
from concurrent.futures import ProcessPoolExecutor
from mancala_ai.agents.dqn import DQNWrapper
from mancala_ai.agents.mcts import mcts_decide
...
def get_cached_dqn():
    if "agent" not in _dqn_cache:
        _dqn_cache["agent"] = DQNWrapper('model_registry/latest/policy.pt')
